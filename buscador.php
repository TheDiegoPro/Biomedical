...
//OBTENCION DEL ID USUARIO DE LA SESSION ACTUAL
...
$sql_articulos = "SELECT * FROM productos WHERE nombre LIKE '%$category%'or descripcion LIKE '$category%' or categoria LIKE '%$category' LIMIT :inicar,:narticulos";
            ...
            <form action="" method="post">
              ...
              <div class="container">
                ...
                <?php } else { ?>
                  ...
                  <br>
                  <button type="button" class="btn btn-outline-info">DETALLE</button>
      ...
      <div class="row mt-5">
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : '' ?>">
                <a class="page-link" href="shop_category.php?category=<?php echo $resultado;?>&pagina=<?php echo $_GET['pagina'] - 1 ?>" tabindex="-1" aria-disabled="true">Anterior</a>
            </li>

            <?php for ($i = 0; $i < $paginas; $i++) : ?>

                <li class="page-item <?php echo $_GET['pagina'] == $i + 1 ? 'active' : '' ?>"><a class="page-link" href="shop_category.php?category=<?php echo $resultado;?>&pagina=<?php echo $i + 1 ?>"><?php echo $i + 1 ?></a></li>

            <?php endfor ?>


            <li class="page-item <?php echo $_GET['pagina'] >= $paginas ? 'disabled' : '' ?>">
                <a class="page-link" href="shop_category.php?category=<?php echo $resultado;?>&pagina=<?php echo $_GET['pagina'] + 1 ?>">Siguiente</a>
            </li>
        </ul>
    </nav>
          </div>
